...
<!--  Start Date Picker -->
<link rel="stylesheet" type="text/css" href="<?php echo asset('resources/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css')?>"/>
<!--  END Date Picker -->
<link id="style_color" href="<?php echo asset('resources/assets/admin/pages/css/qualification.css')?>" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="<?php echo asset('resources/assets/admin/layout2/css/themes/grey.css')?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo asset('resources/assets/admin/layout2/css/custom.css')?>" rel="stylesheet" type="text/css"/>
<link href="<?php echo asset('resources/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css')?>" rel="stylesheet" type="text/css" />
<!-- end theme styles -->
<link rel="shortcut icon" href="favicon.ico"/>
</head>

<body class="qualification">